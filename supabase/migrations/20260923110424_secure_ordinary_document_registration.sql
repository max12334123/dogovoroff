...
comment on function public.register_matter_document(uuid, uuid, text, text, text, bigint)
is 'Registers an owned Storage object for an accessible matter without exposing direct document INSERT.';
