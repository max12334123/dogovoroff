...
const [centerSource, actionsSource, cabinetPageSource, cabinetClientSource, cabinetNavigationSource, staffPageSource, staffClientSource, cssSource] = await Promise.all([
...
test("cabinet keeps notification and profile panels mutually exclusive", () => {
  ...
  assert.match(cabinetNavigationSource, /open=\{headerPanel === "notifications"\}/);
