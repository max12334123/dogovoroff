...
const PRACTICE_DEFINITIONS = [
  ...
  },
  {
    ...
    fallbackNextStep: "Составьте короткий перечень текущих задач и приоритетов для определения подходящего формата сопровождения.",
  },
  {
    id: "housing",
    ...
    fallbackNextStep: "Соберите последний официальный документ и связанные с ним договоры и акты для проверки сроков и позиции.",
  },
  {
    id: "litigation",
